...
var Mappings = []SchemaMapping{
	...
	{Name: "archetypes", JSONLFile: "archetypes.jsonl", StructType: reflect.TypeOf(types.Archetypes{}), Indices: nil},
	...
	{Name: "cloneGrades", JSONLFile: "cloneGrades.jsonl", StructType: reflect.TypeOf(types.CloneGrades{}), Indices: nil},
	{Name: "compressibleTypes", JSONLFile: "compressibleTypes.jsonl", StructType: reflect.TypeOf(types.CompressibleTypes{}), Indices: []string{"compressedTypeID"}},
	...
	{Name: "dungeons", JSONLFile: "dungeons.jsonl", StructType: reflect.TypeOf(types.Dungeons{}), Indices: []string{"archetypeID", "factionID"}},
	...
	{Name: "freelanceJobSchemas", JSONLFile: "freelanceJobSchemas.jsonl", StructType: reflect.TypeOf(types.FreelanceJobSchemas{}), Indices: nil},
	...
	{Name: "mapSecondarySuns", JSONLFile: "mapSecondarySuns.jsonl", StructType: reflect.TypeOf(types.MapSecondarySuns{}), Indices: []string{"effectBeaconTypeID", "solarSystemID", "typeID"}},
	...
	{Name: "mercenaryTacticalOperations", JSONLFile: "mercenaryTacticalOperations.jsonl", StructType: reflect.TypeOf(types.MercenaryTacticalOperations{}), Indices: []string{"dungeonID"}},
	...
	{Name: "typeLists", JSONLFile: "typeLists.jsonl", StructType: reflect.TypeOf(types.TypeLists{}), Indices: nil},
